...
<div class="btn-group">
    ...
    <ul class="dropdown-menu dropdown-menu-lg-end" aria-labelledby="bd-theme-text">
        ...
        <li>
            <button type="button" @click="changeTheme($event)" class="dropdown-item d-flex align-items-center" data-bs-theme-value="dark" aria-pressed="true">
...
export default {
    ...
    mounted(){        
        this.selectedTheme = this.$refs['auto_theme_button'];
    }
}
</script>
<style >
